// Teste de sincronização com GitHub - [data atual]
document.addEventListener('DOMContentLoaded', function() {
    ...
    workspacePanel.addEventListener('drop', function(e) {
        ...
        newIcon.className = 'icon-wrapper workspace-icon dropped';  // Adicionado 'dropped'
        newIcon.innerHTML = iconHtml;
        
        // Remove os manipuladores de redimensionamento
        newIcon.style.width = '300px'; // Largura fixa inicial
        newIcon.style.resize = 'horizontal';
        newIcon.style.overflow = 'auto';
        newIcon.style.minWidth = '50px';
        newIcon.style.maxWidth = '90%';
